                    ...
                    <div class="-mx-3 flex items-center sm:-mx-4">
                        <div class="w-full px-3 sm:px-4 xl:w-1/2">
                            <div class="py-3 sm:py-4">
                                <img src="https://pbs.twimg.com/media/EFIT0mAXkAAqA3T.jpg:large"
                                    alt="" class="w-full rounded-2xl" />
                            </div>
                            <div class="py-3 sm:py-4">
                                <img src="https://animesouls.com/wp-content/uploads/2022/01/Sports-And-Fitness-Anime.jpg"
                                    alt="" class="w-full rounded-2xl" />
                            </div>
                        </div>
                        <div class="w-full px-3 sm:px-4 xl:w-1/2">
                            <div class="relative z-10 my-4">
                                <img src="https://i.ytimg.com/vi/EFEW6yOWbFQ/maxresdefault.jpg"
                                    alt="" class="w-full rounded-2xl" />
                ...
                <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
                    <div class="mt-10 lg:mt-0">
                        ...
                        <h2 class="text-dark mb-8 text-3xl font-bold sm:text-4xl">
                            Это приложение для управления клиентами и тренировочными планами в фитнес клубе.
                        </h2>
                        <p class="text-body-color mb-8 text-base">
                            Приложение предоставляет простой и интуитивно понятный интерфейс пользователя, где можно быстро добавлять и редактировать данные клиентов и тренировочные планы.
                        </p>
